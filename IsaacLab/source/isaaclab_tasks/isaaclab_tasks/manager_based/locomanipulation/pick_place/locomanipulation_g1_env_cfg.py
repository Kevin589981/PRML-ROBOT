...
from isaaclab_tasks.manager_based.locomanipulation.pick_place.configs.pink_controller_cfg_inspire import (  # isort: skip
...
class LocomanipulationG1EnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        temp_urdf_output_path, _ = ControllerUtils.convert_usd_to_urdf(
