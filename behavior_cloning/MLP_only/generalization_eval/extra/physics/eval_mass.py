...
def main() -> None:
    ...
    scales = [0.5, 0.9, 1.0, 1.1, 1.5]

    run_paths = make_run_dirs(args.out_base, category="extra/physics/mass", run_id=args.run_id)
    ...
    for s in scales:
        ...
        print(f"[extra/physics/mass] wrote {len(records)} -> {out_file}")
